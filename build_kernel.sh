...
make -j$(nproc) ARCH=arm O=${PWD}/out \
    CROSS_COMPILE=${PWD}/PLATFORM/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi- \
    CROSS_COMPILE_ARM32=${PWD}/PLATFORM/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
